      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="navbar-header">
          ...
          <?php if ( is_front_page() ) : ?>
            <h1 class="logo pull-left align-middle ">
              <a href="/" class="pull-left" title="海外ビジネス武者修行プログラム"><img class="img-responsive logo-img" src="<?php bloginfo('template_directory'); ?>/img/mushashugyo-logo.png" width="200" alt="海外ビジネス武者修行プログラム"></a>
              <!-- <img class="img-responsive pull-left" src="<?php bloginfo('template_directory'); ?>/img/phone.png" width="200" alt="海外ビジネス武者修行プログラム"> -->
            </h1>
          <?php else : ?>
...
<!--             <li class="hidden-sm hidden-md hidden-lg"><a href="/company/">運営会社</a></li>
            <li class="gray phone-area text-center"><span class="fs20">03-6803-0927</span><br class="hidden-xs hidden-sm">営業時間：10:00-19:00</li> -->
          </ul>
        </div><!-- /.navbar-collapse -->
      </div>
    </div><!-- /.container-fluid -->
